...
@WireMockAppTestSuite(files = "classpath:/SalaryAndPensionRecordsIT/", classes = Application.class)
class SalaryAndPensionRecordsIT extends AbstractAppTest {
	...
	@Test
	void test01_createInvoiceRecordForExternal() {
	...
	@Test
	void test02_createInvoiceRecordForInternal() {
		final var location = setupCall()
			.withServicePath("/2281/billingrecords")
			.withHttpMethod(POST)
			.withRequest(REQUEST_FILE)
