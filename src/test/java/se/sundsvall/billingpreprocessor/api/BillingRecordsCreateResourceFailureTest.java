...
class BillingRecordsCreateResourceFailureTest {
	...
	@Test
	void createBillingRecordWithNullBody() {
		// Call
		...
		assertThat(response.getDetail()).isEqualTo(
			"Required request body is missing: org.springframework.http.ResponseEntity<java.lang.Void> se.sundsvall.billingpreprocessor.api.BillingRecordsResource.createBillingRecord(java.lang.String,se.sundsvall.billingpreprocessor.api.model.BillingRecord)");
	...
	@Test
	void createBillingRecordWithEmptyBody() {
		// Call
		final var response = webTestClient.post().uri(PATH)
			.contentType(APPLICATION_JSON)
	...
	@Test
	void createInternalBillingRecordWithTotallyInvalidInstance() {
		// Parameter values
	...
	@Test
	void createExternalBillingRecordWithTotallyInvalidInstance() {
		// Parameter values
	...
	@Test
	void createExternalBillingRecordWithInvalidVatCode() {
		// Parameter values
		final var request = createBillingRecordInstance(EXTERNAL, true)
	...
	@Test
	void createBillingRecordWithNoAddressDetails() {
		// Parameter values
		final var request = createBillingRecordInstance(EXTERNAL, true)
			.withInvoice(createInvoiceInstance(true, EXTERNAL).withInvoiceRows(List.of(createInvoiceRowInstance(true, EXTERNAL))))
