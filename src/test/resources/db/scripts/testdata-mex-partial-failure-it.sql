-- -----------------------------------
-- Billling records (3 EXTERNAL, 2 INTERNAL - one external has dead partyId)
-- -----------------------------------
...
VALUES ('e4ead2ae-daf7-4993-8f64-f9d24417b189', 'MEX_INVOICE', '2024-02-10 13:37:00.000001', 'MEX',
       ...
       ('61b6f794-10c1-4e3b-8a3d-6d789582e5f9', 'MEX_INVOICE', '2024-02-10 13:37:00.000001', 'MEX',
        '2024-02-09 13:37:00.000001', '2024-02-10 13:37:00.000001', 'APPROVED', 'EXTERNAL', '2281', '2024-02-15'),
       ('aaaa1111-bbbb-cccc-dddd-eeee2222ffff', 'MEX_INVOICE', '2024-02-10 13:37:00.000001', 'MEX',
        '2024-02-09 13:37:00.000001', '2024-02-10 13:37:00.000001', 'APPROVED', 'EXTERNAL', '2281', '2024-02-15'),
...
VALUES (400, 306.0, 1.23, 376.38, '25', 'e4ead2ae-daf7-4993-8f64-f9d24417b189'),
       ...
       (402, 2200.0, 1.00, 2200.00, '25', 'aaaa1111-bbbb-cccc-dddd-eeee2222ffff'),
       (403, 36.84, 1.00, 36.84, '25', 'aaaa1111-bbbb-cccc-dddd-eeee2222ffff'),
...
VALUES (400, NULL, '5757', '15800234', '510', '920360', NULL, NULL, '363000', 369.0),
       ...
       (402, NULL, '5757', '15800234', '510', '920360', NULL, NULL, '363000', 2200.0),
       (403, NULL, '5757', '15800234', '510', '920360', NULL, '11041', '363000', 36.84),
...
VALUES ('MEX Ärendenummer: MEX-25020125', 'STANDARD', 400),
       ...
       ('MEX Ärendenummer: MEX-25030199', 'STANDARD', 402),
       ('MEX Utvecklingskostnad 2%', 'STANDARD', 403),
...
VALUES ('e4ead2ae-daf7-4993-8f64-f9d24417b189', NULL, 'MEX CITY', 'MEX STREET 123', '90102', NULL, NULL,
       ...
       ('aaaa1111-bbbb-cccc-dddd-eeee2222ffff', NULL, 'DEAD CITY', 'DEAD STREET 1', '11111', NULL, NULL,
        'Deceased Estate', 'dead0000-dead-dead-dead-dead00000000', NULL),
...
VALUES ('e4ead2ae-daf7-4993-8f64-f9d24417b189', 'errandId', 'fb19ecf5-a7c2-465e-22ac-c7ea9b4f1c15'),
       ...
       ('aaaa1111-bbbb-cccc-dddd-eeee2222ffff', 'errandId', 'cc33dd44-ee55-ff66-aa77-bb8899001122'),
       ('aaaa1111-bbbb-cccc-dddd-eeee2222ffff', 'errandNumber', 'MEX-25030199'),
       ('aaaa1111-bbbb-cccc-dddd-eeee2222ffff', 'referenceName', 'Case Worker'),
